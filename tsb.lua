...
if NEXAM_LOADED and LPH_OBFUSCATED then
    Notification:Notify("error", "Double Execution Detected", "Please only execute Minimal once!", 5)
    return
end
...
do
    ...
    local Window = Library:AddWindow("Minimal Hub","The Strongest Battlegrounds | discord.gg/minimal")
    ...
    UISection:AddButton("Copy Discord",function()
        ...
        Notification:Notify("info","Copied!","Copied 'discord.gg/minimal' to your clipboard.")
    end)
end
